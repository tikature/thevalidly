...
<head>
    ...
    <title>Batch Sertifikat Tidak Ditemukan - Validly</title>
...
<nav class="navbar-validly">
    <div class="container d-flex align-items-center justify-content-between">
        <a href="{{ route('landing') }}" class="navbar-brand-text">
            <img src="{{ asset('validly-logo1.svg') }}" alt="Validly" style="height:30px;width:30px;margin-right:5px;vertical-align:middle;filter:brightness(0) invert(1)">Validly
        </a>
...
<div class="hero">
    <div class="hero-content">
        ...
        <h1>Batch Sertifikat Tidak Dapat Diakses</h1>
        <p>Link batch yang Anda gunakan tidak valid atau sudah tidak aktif.</p>
    </div>
</div>
...
<div class="container">
    <div class="invalid-card">
        ...
        <div class="invalid-title">Batch Sertifikat Tidak Ditemukan</div>
        <div class="invalid-desc">
            Kami tidak dapat menemukan batch sertifikat yang sesuai dengan link ini.
        ...
        <div class="reasons">
            ...
            <div class="reason-item">
                <i class="bi bi-dot"></i>
                Batch sertifikat belum selesai diproses
            </div>
            <div class="reason-item">
                <i class="bi bi-dot"></i>
                Batch ini telah dihapus oleh penerbit
            </div>
            <div class="reason-item">
                <i class="bi bi-dot"></i>
                Link dibagikan tidak lengkap saat menyalin
            </div>
        </div>
