...
/**
 * Unit Test: BackgroundLibrary Model — Iterasi 2
 *
 * Lingkup: scopeSystem, scopeForInstitution, getUrlAttribute, relasi institution.
 * Sesuai US-06 (Manajemen Background Default).
 *
