...
/**
 * Unit Test: RoleMiddleware — Iterasi 1
 *
 * Menguji logika pengecekan role dan status aktif user.
 * Sesuai US-01 (Autentikasi Pengguna).
 *
...
class RoleMiddlewareTest extends TestCase
{
    ...
    #[Test]
    public function inactive_user_redirect_carries_deactivation_error(): void
    {
        $institution = Institution::factory()->create();
        $admin       = User::factory()->adminOf($institution)->inactive()->create();
        $this->actingAs($admin);
        ...
        $this->assertStringContainsString('dinonaktifkan', $errors->first('email'));
    }
}
